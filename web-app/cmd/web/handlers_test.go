...
func Test_application_handlers(t *testing.T) {
	var theTests = []struct {
		...
		{"not found", "/fish", http.StatusNotFound, "/fish", http.StatusNotFound},
...
func Test_app_UploadedProfilePic(t *testing.T) {
	...
	// create a bytes.Buffer to act as the
	...
	handler := http.HandlerFunc(app.UploadProfilePics)
