...
func Test_application_addIPToContext(t *testing.T) {
	...
	nexHandler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
	...
	for _, e := range tests {
		...
		handlerToTest := app.addIPToContext(nexHandler)
...
func Test_application_ipFromContext(t *testing.T) {
	...
	// put something in the context using user_key
...
func Test_app_auth(t *testing.T) {
	nexhHandler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
	...
	for _, e := range tests {
		handlerToTest := app.auth(nexhHandler)
		req := httptest.NewRequest("GET", "http://testing", nil)
